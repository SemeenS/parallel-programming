...
Изучить работу с файлами на языке C++, реализовать алгоритм перемножения квадратных матриц, измерить время выполнения программы и определить объём вычислений.
